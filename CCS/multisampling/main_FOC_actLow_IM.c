...
// Defines for IREG
#define R 13.0f  // 0.09871f                           // Motor resistance
#define L 0.05358f  //0.0025f                            // Motor inductance
#define INV_TAU (R/L)                               // 1/(L/R)

// defines for slip calculation
#define RR 0.5744f   //0.108f                       // Rotor phase resistance referred to stator
#define LR 0.472f    //0.0484f                          // Rotor phase inductance referred to stator (Lr = Llr + Lm)
#define ID_NOM 1.6524f  //18.55f                        // Nominal d current
